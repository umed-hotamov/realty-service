...
func (l *PgListingRepo) GetUserListings(ctx context.Context, userID domain.ID) ([]domain.Listing, error) {
	var pgListings []entity.PgListing
...
func (l *PgListingRepo) Delete(ctx context.Context, listingID domain.ID) error {
